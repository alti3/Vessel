...
public sealed class UnavailableVesselDbContext : IVesselDbContext
{
    ...
    public IQueryable<EnvironmentVariable> EnvironmentVariables =>
        Enumerable.Empty<EnvironmentVariable>().AsQueryable();
    ...
    public IQueryable<PersonalAccessToken> PersonalAccessTokens =>
        Enumerable.Empty<PersonalAccessToken>().AsQueryable();
    ...
    public IQueryable<ApplicationWebhookConfiguration> ApplicationWebhookConfigurations =>
        Enumerable.Empty<ApplicationWebhookConfiguration>().AsQueryable();
    ...
    public IRepository<TeamInvitation, TeamInvitationId> TeamInvitationRepository { get; } =
        new UnavailableRepository<TeamInvitation, TeamInvitationId>();

    public IRepository<PersonalAccessToken, PersonalAccessTokenId> PersonalAccessTokenRepository { get; } =
        new UnavailableRepository<PersonalAccessToken, PersonalAccessTokenId>();
    ...
    public IRepository<EnvironmentEntity, EnvironmentId> EnvironmentRepository { get; } =
        new UnavailableRepository<EnvironmentEntity, EnvironmentId>();
