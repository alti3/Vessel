...
public sealed class RealtimeGroupNamesTests
{
    ...
    public void GroupNamesAreDeterministic()
    {
        ...
        Assert.Equal("application:11111111-2222-3333-4444-555555555555",
            RealtimeGroupNames.Application(new ApplicationId(id)));
        Assert.Equal("deployment:11111111-2222-3333-4444-555555555555",
            RealtimeGroupNames.Deployment(new DeploymentId(id)));
